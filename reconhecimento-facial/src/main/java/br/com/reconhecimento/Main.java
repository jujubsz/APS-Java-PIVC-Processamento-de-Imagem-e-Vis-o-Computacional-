...
public class Main {
    ...
    private static void inicializarSistema() {
        ...
        sistema = new SistemaReconhecimentoFacial(
            TipoAlgoritmo.FISHER,
        ...
        sistema.adicionarUsuario(usuario.getNome(), usuario.getCargo(), usuario.getNivelAcesso(), usuario.getCaminhosFotos());
    ...
    private static void menuPrincipal() {
        while (true) {
            ...
            System.out.println("=".repeat(60));
            System.out.println("1 - Fazer Login (Reconhecimento Facial)");
            System.out.println("2 - Acessar como Público Geral");
    ...
    private static void carregarUsuariosExemplo() {
        ...
        // Ministro
        int idMinistro = bancoDados.cadastrarUsuario(
        ...
        // Diretor 1
        int idDiretor1 = bancoDados.cadastrarUsuario(
            "Diretor do Meio Ambiente 1",
            "Diretor",
            NivelAcesso.DIRETOR
        );
        ...
        // Diretor 2
        int idDiretor2 = bancoDados.cadastrarUsuario(
            "Diretor do Meio Ambiente 2",
            "Diretor",
            NivelAcesso.DIRETOR
        );
